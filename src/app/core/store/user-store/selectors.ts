...
const isLoginFailed = (state: State): boolean => state.isLoginFailed;
...
export const isLoginFailedSelect: MemoizedSelector<object, boolean> = createSelector(selectUserState, isLoginFailed);
